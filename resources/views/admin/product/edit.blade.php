...
<form action="{{ url('update-product/'.$product->id) }}" method="POST" style="margin:15vh auto auto 0; width:65vw;">
  ...
  <div class="form-group" >
    ...
    <input value="{{$product->image}}" required style="color:white;" type="text" class="form-control" id="image" name="image" placeholder="Image URL">
  </div>
  <div class="form-group" >
    <label for="price">Price</label>
    <input value="{{$product->price}}" required style="color:white;" type="text" pattern="[0-9]+" class="form-control" id="price" name="price" placeholder="Product Price">
  </div>
  <div class="form-group" >
  ...
  <div class="form-group">
    ...
    <textarea required name="brief" id="brief" style="color:white;" class="form-control" id="exampleFormControlTextarea1" rows="3">{{$product->brief}}</textarea>
  </div>
  <div class="form-group">
